...
--
-- Host: localhost
-- Generation Time: Jan 04, 2024 at 11:10 AM
...
('998ccc62-d6a0-11ed-962c-0c7a158e4469', 'stripe', '{\"gateway\":\"stripe\",\"mode\":\"live\",\"status\":\"1\",\"api_key\":null,\"published_key\":null}', '{\"gateway\":\"stripe\",\"mode\":\"live\",\"status\":\"1\",\"api_key\":null,\"published_key\":null}', 'payment_config', 'live', 0, NULL, '2023-08-30 04:18:55', '{\"gateway_title\":\"Stripe\",\"gateway_image\":null}'),
...
(3, 'restaurant_name', 'Business Name', NULL, NULL),
(4, 'currency', 'USD', NULL, NULL),
(5, 'logo', '2021-06-12-60c493426bd7a.png', NULL, NULL),
(6, 'mail_config', '{\"status\":0,\"name\":\"Delivery APP\",\"host\":\"mail.demo.com\",\"driver\":\"smtp\",\"port\":\"587\",\"username\":\"info@demo.com\",\"email_id\":\"info@demo.com\",\"encryption\":\"tls\",\"password\":\"demo\"}', NULL, '2024-01-03 17:09:14'),
...
(1, 'Test Category', 0, 0, 1, '2023-11-24 16:19:11', '2023-11-24 16:19:11', '2023-11-24-6561bc0f3b44f.png', '2023-11-24-6561bc0f3c791.png', 0),
(2, 'Test Sub Category', 1, 1, 1, '2023-11-24 16:19:23', '2023-11-24 16:19:23', 'def.png', 'def.png', 0);
...
(103, '2023_10_30_113137_create_flash_sales_table', 53),
(104, '2023_10_30_191529_create_flash_sale_products_table', 53),
(105, '2023_11_12_112550_add_is_featured_column_in_categories_table', 53),
(106, '2023_11_14_134134_add_column_banner_type_in_banners_table', 53);
...
INSERT INTO `products` (`id`, `name`, `description`, `image`, `price`, `variations`, `tax`, `status`, `created_at`, `updated_at`, `attributes`, `category_ids`, `choice_options`, `discount`, `discount_type`, `tax_type`, `unit`, `total_stock`, `min_order_qty`) VALUES
(1, 'Test Product', '<p>Test Product Description</p>', '[\"2023-11-24-6561bc4d40ec5.png\"]', 100, '[]', '0.00', 1, '2023-11-24 16:20:13', '2023-11-24 16:20:13', '[]', '[{\"id\":\"1\",\"position\":1},{\"id\":\"2\",\"position\":2}]', '[]', '0.00', 'percent', 'percent', 'kg', 56, 1);
