...
<body>
    <section style="background-image: url('{{ asset('public/assets/installation/assets/img/page-bg.png') }}')"
        ...
        <div class="logo">
            <img src="{{ asset('public/assets/installation/assets/img/favicon.svg') }}"
            ...
            <footer class="footer py-3 mt-4">
                <div class="d-flex flex-column flex-sm-row justify-content-between gap-2 align-items-center">
                    <div class="footer-logo">
                        <img src="{{ asset('public/assets/installation/assets/img/logo.svg') }}"
                            alt="{{ translate('logo') }}">
                    </div>
                    <p class="copyright-text mb-0">© {{ translate('2024 | All Rights Reserved') }}</p>
                </div>
            </footer>
        </div>
    </section>
