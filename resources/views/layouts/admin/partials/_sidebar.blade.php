            ...
            <div class="navbar-vertical-footer-offset">
                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{ Request::is('admin/product/add-new') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.product.add-new') }}"
                                        ...
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{ translate('add') }}
                                            {{ translate('new') }}</span>
                                    </a>
                                </li>
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/sms-module') ||
                            Request::is('admin/business-settings/mail-config') ||
                            Request::is('admin/business-settings/payment-method') ||
                            Request::is('admin/business-settings/recaptcha') ||
                            Request::is('admin/business-settings/map-api-settings') ||
                            Request::is('admin/business-settings/fcm-index') ||
                            Request::is('admin/business-settings/firebase-message-config') ||
                            Request::is('admin/business-settings/social-media-login') ||
                            Request::is('admin/business-settings/social-media-chat')
                                ? 'active'
                                : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/social-media') ||
                            Request::is('admin/business-settings/return-page') ||
                            Request::is('admin/business-settings/about-us') ||
                            Request::is('admin/business-settings/privacy-policy') ||
                            Request::is('admin/business-settings/terms-and-conditions') ||
                            Request::is('admin/business-settings/cancellation-page') ||
                            Request::is('admin/business-settings/refund-page')
                                ? 'active'
                                : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ Request::is('admin/business-settings/social-media') ||
                                Request::is('admin/business-settings/return-page') ||
                                Request::is('admin/business-settings/about-us') ||
                                Request::is('admin/business-settings/privacy-policy') ||
                                Request::is('admin/business-settings/terms-and-conditions') ||
                                ...
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/return-page') ||
                                    Request::is('admin/business-settings/about-us') ||
                                    Request::is('admin/business-settings/privacy-policy') ||
                                    Request::is('admin/business-settings/terms-and-conditions') ||
                                    Request::is('admin/business-settings/cancellation-page') ||
                                ...
                                <li
                                    ...
                                    <a class="nav-link " href="{{ route('admin.business-settings.social-media') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/app-setting') || Request::is('admin/business-settings/db-index') || Request::is('admin/business-settings/location-setup') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
