...
class ConfigController extends Controller
{
    public function configuration(): \Illuminate\Http\JsonResponse
    {
        ...
        return response()->json([
            ...
            'play_store_config' => [
                "status" => (bool)Helpers::get_business_settings('play_store_config')['status'],
            ...
            'app_store_config' => [
                "status" => (bool)Helpers::get_business_settings('app_store_config')['status'],
            ...
            'social_login' => [
                'google' => (int)BusinessSetting::where(['key' => 'google_social_login'])->first()->value,
                'facebook' => (int)BusinessSetting::where(['key' => 'facebook_social_login'])->first()->value,
            ],
            ...
            'digital_payment_status' => (int)$digitalPaymentStatusValue['status'],
            'active_payment_method_list' => (int)$digitalPaymentStatusValue['status'] == 1 ? $activeAddonPaymentList : [],
        ]);
    }
